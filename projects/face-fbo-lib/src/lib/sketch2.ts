...
// @ts-ignore
const vertex = vertexFaceParticles;
// @ts-ignore
const fragment = fragmentParticles;
// @ts-ignore
const  fragmentSim = fragmentSimulation;
// @ts-ignore
import fragmentSimulation2 from './assets/shaders/fragment-simulation2.glsl';
import gsap from 'gsap';
import {vertexFaceParticles} from './shaders/vertex-particles';
import {fragmentParticles} from './shaders/fragment-particles';
import {fragmentSimulation} from './shaders/fragment-simulation';
